...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0x01] = { draw_gi_various_opa0,        { 0x06000800 } }, // Small Key
    [0x02] = { draw_gi_various_xlu01,       { 0x06000A80, 0x06000AE0 } }, // Music Note (Green)
    [0x03] = { draw_gi_various_xlu01,       { 0x06000A90, 0x06000AE0 } }, // Music Note (Red)
    [0x04] = { draw_gi_various_xlu01,       { 0x06000AA0, 0x06000AE0 } }, // Music Note (Blue)
    [0x05] = { draw_gi_various_xlu01,       { 0x06000AB0, 0x06000AE0 } }, // Music Note (Orange)
    [0x06] = { draw_gi_various_xlu01,       { 0x06000AC0, 0x06000AE0 } }, // Music Note (Purple)
    [0x07] = { draw_gi_various_xlu01,       { 0x06000AD0, 0x06000AE0 } }, // Music Note (Yellow)
    [0x08] = { draw_gi_recovery_heart,      { 0x060000E0 } }, // Recovery Heart
    [0x09] = { draw_gi_various_opa0_xlu1,   { 0x06000CA0, 0x06000F08 } }, // Boss Key
