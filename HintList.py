...
hintTable = {
    ...
    'GV Grotto Ledge -> GV Octorok Grotto':                     ("on #a ledge in the valley#, a silver rock hides", None, 'entrance'),
    ...
    'SFM Forest Temple Entrance Ledge -> Forest Temple Lobby':  ("deep #within the Meadow#, one can find", None, 'entrance'),
    'Gerudo Fortress -> Gerudo Training Grounds Lobby':         ("paying a fee #within Gerudo's Fortress# grants access to", None, 'entrance'),
    'ZF Ice Ledge -> Ice Cavern Beginning':                     ("in #a frozen fountain#, an opening leads to", None, 'entrance'),
